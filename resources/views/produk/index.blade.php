            ...
            <div class="modal-body">
                <form action="/produk/create" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="maks_kecil" type="number" class="form-control" placeholder="Maksimal di Kemasan Kecil">
                    </div>
                    <div class="form-group">
                    <label for="exampleInputEmail1">Maksimal di Kemasal Sedang</label>
                    <input name="maks_sedang" type="number" class="form-control" placeholder="Maksimal di Kemasan Sedang">
                    </div>
                    <div class="form-group">
                    <label for="exampleInputEmail1">Maksimal di Kemasal Besar</label>
                    <input name="maks_besar" type="number" class="form-control" placeholder="Maksimal di Kemasan Besar">
                    </div>
                    <div class="form-group">
